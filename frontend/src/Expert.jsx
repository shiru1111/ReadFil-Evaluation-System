              ...
              {micStatus !== 'playback_ready' ? (
                <div className="relative flex items-center justify-center">
                  ...
                  <button
                    ...
                    className={`w-24 h-24 rounded-full flex items-center justify-center shadow-lg transform transition-all relative z-10 ${micStatus === 'recording_test' ? 'bg-red-600 hover:bg-red-700 animate-pulse scale-110' : 'bg-[#005FA3] hover:bg-[#004A80] hover:scale-105'
                      }`}
                  >
            ...
            {!hasRecorded && (
              <div className="relative flex items-center justify-center">
                ...
                <button
                  ...
                  className={`w-24 h-24 rounded-full flex items-center justify-center shadow-lg transition-all relative z-10 ${isRecording ? 'bg-red-600 hover:bg-red-700 animate-pulse' : 'bg-[#005FA3] hover:bg-[#004A80]'} ${(isProcessing || isCountingDown) ? 'opacity-50 cursor-not-allowed' : 'hover:scale-105'}`}
                >
                  <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    {isRecording ? (
